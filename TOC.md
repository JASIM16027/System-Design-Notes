...
| # | Topic | কী আছে |
|---|-------|--------|
| 24 | [গল্পে গল্পে System Design](24.%20গল্পে%20গল্পে%20System%20Design.md) | তানহার "পড়ুয়া" অ্যাপ ৫ জন থেকে ৫০ লাখ user-এ — ১০ অধ্যায়ে scaling, load balancer, protocol, CDN, caching, sharding, replication, CAP/PACELC |
