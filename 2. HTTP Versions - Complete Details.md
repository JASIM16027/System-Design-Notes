...
* [1. HTTP/1.0 (1996)](#1-http10-1996)
  * [Definition](#definition-1)
  * [Key Features](#key-features)
  * [How It Works](#how-it-works)
  * [HTTP/1.0 Request Example](#http10-request-example)
  * [Problems with HTTP/1.0](#problems-with-http10)
* [2. HTTP/1.1 (1997)](#2-http11-1997)
  * [Definition](#definition-2)
  * [Major Improvements](#major-improvements)
  * [1. Persistent Connections (Keep-Alive)](#1-persistent-connections-keep-alive)
  * [2. HTTP Pipelining](#2-http-pipelining)
  * [3. Host Header (Virtual Hosting)](#3-host-header-virtual-hosting)
  * [4. Chunked Transfer Encoding](#4-chunked-transfer-encoding)
  * [5. Better Caching](#5-better-caching)
  * [6. Range Requests](#6-range-requests)
  * [HTTP/1.1 Complete Request Example](#http11-complete-request-example)
  * [HTTP/1.1 Problems](#http11-problems)
* [3. HTTP/2 (2015)](#3-http2-2015)
  * [Definition](#definition-3)
  * [Major Features](#major-features)
  * [1. Binary Protocol](#1-binary-protocol)
  * [2. Multiplexing (সবচেয়ে গুরুত্বপূর্ণ!)](#2-multiplexing-সবচেয়ে-গুরুত্বপূর্ণ)
  * [3. Header Compression (HPACK)](#3-header-compression-hpack)
  * [4. Server Push](#4-server-push)
  * [5. Stream Prioritization](#5-stream-prioritization)
  * [HTTP/2 Complete Example](#http2-complete-example)
* [HTTP Versions Comparison](#http-versions-comparison)
  * [Complete Comparison Table](#complete-comparison-table)
  * [Performance Comparison](#performance-comparison)
* [Real World Example](#real-world-example)
  * [Complete Page Load](#complete-page-load)
