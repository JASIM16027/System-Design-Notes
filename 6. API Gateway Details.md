...
* [🚪 API Gateway কি?](#-api-gateway-কি)
* [🔄 Request Flow (Step-by-step)](#-request-flow-step-by-step)
* [🎯 Key Insight](#-key-insight)
* [**Single Entry Point**](#single-entry-point)
* [🧠 Simple Diagram (Text)](#-simple-diagram-text)
* [🧾 Summary](#-summary)
* [⚖️ Load Balancer vs API Gateway](#-load-balancer-vs-api-gateway)
* [❓ প্রশ্ন: Load Balancer কি Gateway-এর মতোই কাজ করে?](#-প্রশ্ন-load-balancer-কি-gateway-এর-মতোই-কাজ-করে)
* [🔹 Load Balancer কি করে?](#-load-balancer-কি-করে)
* [🔹 API Gateway কি করে?](#-api-gateway-কি-করে)
* [🔄 তারা একসাথে কিভাবে কাজ করে?](#-তারা-একসাথে-কিভাবে-কাজ-করে)
* [🎯 Key Insight](#-key-insight-1)
* [🧠 Simple Diagram (Text)](#-simple-diagram-text-1)
* [🧾 Summary](#-summary-1)
* [🔐 Authentication (OAuth 2.0 Flow)](#-authentication-oauth-20-flow)
* [🔄 Step-by-step Flow](#-step-by-step-flow)
* [🔍 Service Discovery](#-service-discovery)
* [🧩 Registry update করার 2টা approach](#-registry-update-করার-2টা-approach)
  * [**Approach 1 — Self-registration**](#approach-1--self-registration)
  * [**Approach 2 — Health-check-based**](#approach-2--health-check-based)
* [🔄 Request Flow (Step-by-step)](#-request-flow-step-by-step-1)
* [🎯 Key Insight](#-key-insight-2)
* [**single source of truth**](#single-source-of-truth)
* [🧠 Quick Summary](#-quick-summary)
* [🧭 Full Architecture — Layer by Layer](#-full-architecture--layer-by-layer)
  * [**Client → DNS**](#client--dns)
  * [**DNS → API Gateway**](#dns--api-gateway)
  * [**API Gateway ↔ Service Discovery**](#api-gateway--service-discovery)
  * [**Gateway → Load Balancer**](#gateway--load-balancer)
  * [**Load Balancer → Microservice Instances**](#load-balancer--microservice-instances)
  * [**AZ1 & AZ2 — কেন দুইটা Zone?**](#az1--az2--কেন-দুইটা-zone)
  * [**Traffic Flow across AZ**](#traffic-flow-across-az)
* [**High Availability (HA)**](#high-availability-ha)
  * [**Extra Protection (Inside AZ)**](#extra-protection-inside-az)
* [🧠 Summary (Shortcut)](#-summary-shortcut)
