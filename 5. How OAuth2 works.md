...
* [OAuth2 — বিস্তারিত সহজ ভাষায়](#oauth2--বিস্তারিত-সহজ-ভাষায়)
  * [Hotel Key Card Analogy](#hotel-key-card-analogy)
  * [চারটি Actor — এদের চেনো আগে](#চারটি-actor--এদের-চেনো-আগে)
  * [Step-by-Step Flow — প্রতিটি ধাপ বিস্তারিত](#step-by-step-flow--প্রতিটি-ধাপ-বিস্তারিত)
  * [Authorization Code কেন? সরাসরি Token কেন না?](#authorization-code-কেন-সরাসরি-token-কেন-না)
  * [Scope — Limited Permission-এর মূল concept](#scope--limited-permission-এর-মূল-concept)
  * [Authentication vs Authorization — এই দুটো এক জিনিস না](#authentication-vs-authorization--এই-দুটো-এক-জিনিস-না)
* [কয়েকটা গুরুত্বপূর্ণ technical detail যা সবাই miss করে](#কয়েকটা-গুরুত্বপূর্ণ-technical-detail-যা-সবাই-miss-করে)
