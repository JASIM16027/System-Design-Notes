...
* [Proxy মানে কী?](#proxy-মানে-কী)
* [১. Forward Proxy — Client-এর পক্ষে কাজ কর](#১-forward-proxy--client-এর-পক্ষে-কাজ-কর)
* [২. Reverse Proxy — Server-এর পক্ষে কাজ কর](#২-reverse-proxy--server-এর-পক্ষে-কাজ-কর)
* [৩. পাশাপাশি তুলনা — মূল পার্থক্যটা বোঝো---](#৩-পাশাপাশি-তুলনা--মূল-পার্থক্যটা-বোঝো---)
* [৪. Real traffic-এ HTTP header-এ কী দেখায়](#৪-real-traffic-এ-http-header-এ-কী-দেখায়)
* [৫. একটাই জিনিস মনে রেখো](#৫-একটাই-জিনিস-মনে-রেখো)
