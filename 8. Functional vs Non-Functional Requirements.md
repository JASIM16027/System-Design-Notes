...
* [আগে একটা real-life example দিয়ে শুরু করি](#আগে-একটা-real-life-example-দিয়ে-শুরু-করি)
* [Functional Requirements — সহজ ভাষায়](#functional-requirements--সহজ-ভাষায়)
  * [WhatsApp-এর Functional Requirements](#whatsapp-এর-functional-requirements)
  * [YouTube-এর Functional Requirements](#youtube-এর-functional-requirements)
* [Non-Functional Requirements — সহজ ভাষায়](#non-functional-requirements--সহজ-ভাষায়)
  * [সবচেয়ে Common Non-Functional Requirements](#সবচেয়ে-common-non-functional-requirements)
* [Availability বিস্তারিত — 9-এর হিসাব](#availability-বিস্তারিত--9-এর-হিসাব)
* [Consistency vs Availability — এখানে একটা Tradeoff আছে](#consistency-vs-availability--এখানে-একটা-tradeoff-আছে)
* [Latency vs Throughput — আরেকটা Tradeoff](#latency-vs-throughput--আরেকটা-tradeoff)
* [দুটোর মধ্যে পার্থক্য এক নজরে](#দুটোর-মধ্যে-পার্থক্য-এক-নজরে)
* [Interview-তে কীভাবে বলবে](#interview-তে-কীভাবে-বলবে)
