...
## 📖 গল্প দিয়ে শুরু করতে চাইলে

| Topic | কী আছে |
|-------|--------|
| 📚 **[Golpo/ — গল্পে গল্পে System Design](Golpo/README.md)** ⭐ | **১১ অধ্যায়ের পূর্ণ সিরিজ।** তানহার "পড়ুয়া" অ্যাপ ৫ জন থেকে ৫০ লাখ user-এ — প্রতিটা অধ্যায়ে একটা করে সমস্যা ভাঙে আর একটা concept আসে |
| [24. সংক্ষিপ্ত সংস্করণ](24.%20গল্পে%20গল্পে%20System%20Design.md) | পুরো গল্পটা এক ফাইলে — দ্রুত পড়ার জন্য |

**সিরিজের অধ্যায়গুলো:** [প্রলোগ](Golpo/00.%20প্রলোগ%20-%20হলের%20৩০৪%20নম্বর%20রুম.md) · [System Design কী](Golpo/01.%20System%20Design%20জিনিসটা%20আসলে%20কী.md) · [Scaling](Golpo/02.%20পরীক্ষার%20আগের%20রাত%20-%20Scaling.md) · [Load Balancer](Golpo/03.%20দারোয়ান%20চাচা%20-%20Load%20Balancer.md) · [Protocol](Golpo/04.%20চিঠিটা%20যায়%20কীভাবে%20-%20Networking%20Protocol.md) · [CDN](Golpo/05.%20দূরত্বই%20শত্রু%20-%20CDN.md) · [Caching](Golpo/06.%20ডাটাবেসের%20জ্যাম%20-%20Caching.md) · [Sharding](Golpo/07.%20আলমারি%20ভাগ%20-%20Partitioning%20ও%20Sharding.md) · [Replication](Golpo/08.%20যেদিন%20হার্ডডিস্ক%20মরে%20গেলো%20-%20Replication.md) · [CAP/PACELC](Golpo/09.%20নতুন%20বিপত্তি%20-%20CAP%20ও%20PACELC.md) · [উপসংহার](Golpo/10.%20তানহার%20শেষ%20শিক্ষা.md)

> একদম নতুন হলে **এখান থেকেই শুরু করো** — পুরো ছবিটা গল্পে পেয়ে যাবে, তারপর নিচের note গুলোতে গভীরে যাও।
...
**একদম নতুন হলে:** আগে **24** (পুরো গল্প) → তারপর 1 → 2 → A1 → 3 → 4 → 8 → 9 → 10 → 11
